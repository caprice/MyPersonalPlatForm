	...
	<body>
		...
		<br/><br/>
				<logic:present name="client" scope="session">
					...
					<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;* 请备忘录创建或查看备忘录列表</font><br /><br />
					
					<a href="createtremind.jsp">创建备忘录</a><br/><br />
					<a href="listtremind.do">查看备忘录列表</a><br/><br />
				</logic:present>
				<logic:notPresent name="client" scope="session">
					<font color="red" size="5">&nbsp;&nbsp;&nbsp;&nbsp;* 请先登录再进行备忘录创建或查看备忘录列表</font><br /><br />
				</logic:notPresent>
