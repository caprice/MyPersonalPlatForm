...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br/><br/>
				...
				<font size="5" color="blue">&nbsp;&nbsp;&nbsp;&nbsp;用户信息修改</font>
				<form action="modifyuser.do" method="post">
				
				<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;* 请详细填写以下信息进行信息修改</font><br /><br />
				<table cellspacing="15">
					<tr>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;用&nbsp;&nbsp;户&nbsp;&nbsp;名：</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="username" value="${client.username }" size="30" onMouseOver="showwin()" onMouseOut="hide()"/></td>
						<td><div id="win">
					...
					<tr>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="truename" value="${client.truename }" size="30"  onMouseOver="showwin_tname()" onMouseOut="hide_tname()"/></td>
						<td><div id="win_tname">
					...
					<tr>
						...
						<td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="email" value="${client.email }" size="30" onMouseOver="showwin_email()" onMouseOut="hide_email()"/></td>
						<td><div id="win_email">
					...
					<tr>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;联系方式：</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="tel" value="${client.tel }" size="30" onMouseOver="showwin_tel()" onMouseOut="hide_tel()"/></td>
						<td><div id="win_tel">
					...
					<tr>
						...
						<td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="QQ" value="${client.QQ }" size="30" onMouseOver="showwin_qq()" onMouseOut="hide_qq()"/></td>
						<td><div id="win_qq">
					...
					<tr>
						...
						<td>&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="7" cols="29"  name="description" onMouseOver="showwin_des()" onMouseOut="hide_des()">${client.description }</textarea></td>
						<td><div id="win_des">
				...
				<logic:notPresent name="client">
					<font color="red" size="6"> 对不起 ！ 您还没有登录！</font>
				</logic:notPresent>
			<p class="dotline">
