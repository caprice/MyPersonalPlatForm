...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br/><br/>
				<logic:present name="client" scope="session">
					<font size="5" color="blue">&nbsp;&nbsp;&nbsp;&nbsp;用户文件上传</font>
					<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;* 请请选择要上传的文件</font><br /><br />
					<center>
					<form action="uploading.do" method="post" enctype="multipart/form-data">
				...
				<logic:notPresent name="client" scope="session">
					<font color="red" size="5">&nbsp;&nbsp;&nbsp;&nbsp;* 请先登录再进行文件上传</font><br /><br />
				</logic:notPresent>
