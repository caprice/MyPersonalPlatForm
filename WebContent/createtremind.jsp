...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="bodyPanel">
		<br/><br/>
				<font size="5" color="blue">&nbsp;&nbsp;&nbsp;&nbsp;用户备忘录</font>
				<form action="createtremind.do" method="post">
				
				<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;* 请详细填写以下信息进行备忘录创建</font><br /><br />
				<table cellspacing="15">
					<tr>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;主&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="theme" size="30" onMouseOver="showwin()" onMouseOut="hide()"/></td>
						<td><div id="win">
							 <div id="title">&nbsp;<b>主题输入：</b></div>
					         <div id="content">
					            &nbsp;&nbsp;&nbsp;5-38位字符，<br/>
								&nbsp;&nbsp;&nbsp;可以是任意字符
					         </div>
