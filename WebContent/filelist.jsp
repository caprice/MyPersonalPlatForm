				...
				<logic:present name="fileList">
					...
					<table width="90%" align="center" style="border:2px #d0cfd5 solid">
						...
						<tr>
							...
							<td>${fileList.filesize /1024 } KB</td>
							<td>${fileList.uploadtime }</td>
							<td>${fileList.ispublic }</td>
							<td><a href="share.do?fileid=${fileList.fileid }">共享此文件</a> &nbsp;|&nbsp; <a href="unshare.do?fileid=${fileList.fileid }">撤销共享</a></td>
						</tr>
						</c:forEach>
					</table>
					</logic:notEmpty>
